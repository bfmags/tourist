# Tourist.js [![Build Status](https://travis-ci.org/tomrosier/tourist.png)](https://travis-ci.org/tomrosier/tourist)
...
* `highlightClass` optional string, this is the css class that can be optionally applied to override or add to the .tourist-highlight 
